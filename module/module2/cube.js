...
window.onload = function f() {
    ...
    d3.select('body')
        .append('p')
        .attr('id', 'textinput')
        .attr("style", "position:absolute; left:100px; top:15px;")
        .text('輸入卷積大小:')

    d3.select('body')
        .append('p')
        .attr('id', 'textinput')
        .attr("style", "position:absolute; left:290px; top:-5px;")
        .text('卷積遮罩大小:')
    d3.select('body')
        .append('p')
        .attr('id', 'textinput')
        .attr("style", "position:absolute; left:480px; top:-5px;")
        .text('移動步伐大小:')
    ...
    var select3 = d3.select('body')
        ...
        .attr('class', 'select')
        .attr('id', 'input')
        .attr("style", "position:absolute; left:200px; top:10px;")
        .on('change', onchange)
    ...
    // ----- create option ----------   
    var data4 = ["tensor 1", "tensor 2"];
    var select4 = d3.select('body')
        .append('select')
        .attr('class', 'select')
        .attr('id', 'tensor')
        .attr("style", "position:absolute; left:200px; top:30px;")
        .on('change', onchange)
    ...
    var select2 = d3.select('body')
        ...
        .attr('class', 'select')
        .attr('id', 'conv')
        .attr("style", "position:absolute; left:390px; top:10px;")
        .on('change', onchange)
    ...
    var select = d3.select('body')
        ...
        .attr('class', 'select')
        .attr('id', 'strike')
        .attr("style", "position:absolute; left:580px; top:10px;")
        .on('change', onchange)
