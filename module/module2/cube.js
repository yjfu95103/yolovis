...
window.onload = function f() {
    ...
    function init(){
        ...
        cubesData = setCube(5,5,1,0,6,13,cubesData,'input0','#6beaf32f')        
        cubesData = setCube(5,5,1,0,6,14,cubesData[0],'input','#6beaf32f')
        inputfront = cubesData[1];
        // console.log('input front',inputfront)
        cubesData = setCube(3,3,1,-10,6,25,cubesData[0],'filter0','#D83737dd')
        cubesData = setCube(3,3,1,0,6,25,cubesData[0],'filter1','#6dff8add')
        cubesData = setCube(3,3,1,10,6,25,cubesData[0],'filter2','#7beafedd')
       ...
       //--------------------------
        ...
        cubesData = setCube(3,3,1,0,6,35,cubesData[0],'output','#D83737dd')  
        cubesData = setCube(3,3,1,0,6,36,cubesData[0],'output','#6dff8add') 
        cubesData = setCube(3,3,1,0,6,37,cubesData[0],'output','#7beafedd') 
     ...
     function strikeOne(){
        for(var i = 0; i < 10000; i++){
            ...
            if(times%3==0){
                ...
                changeColor = '#7beafedd';
            }
           conv(12 ,1+9*i,changeColor);
            conv(11 ,2+9*i,changeColor);
            conv(10 ,3+9*i,changeColor);
            conv(7 ,4+9*i,changeColor);
            conv(6 ,5+9*i,changeColor);
            conv(5 ,6+9*i,changeColor);
            conv(2 ,7+9*i,changeColor);
            conv(1 ,8+9*i,changeColor);
            conv(0 ,9+9*i,changeColor); 
